...
/**
 * Esta clase llamar la interacciones que se encargan de agregar productos
 */

import com.co.certificacion.retowebtest.interactions.AgregarAlCarrito;
...
public class SeleccionarProducto implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                AgregarAlCarrito.deCompras(listProd)
        );
    }
}